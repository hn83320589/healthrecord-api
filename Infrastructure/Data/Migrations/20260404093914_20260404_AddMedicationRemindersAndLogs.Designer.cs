...
namespace HealthRecord.API.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260404093914_20260404_AddMedicationRemindersAndLogs")]
    partial class _20260404_AddMedicationRemindersAndLogs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthRecord.API.Models.Entities.MedicationLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReminderId", "ScheduledAt")
                        .HasDatabaseName("idx_log_reminder");

                    b.HasIndex("UserId", "ScheduledAt")
                        .HasDatabaseName("idx_log_user_date");
            ...
            modelBuilder.Entity("HealthRecord.API.Models.Entities.MedicationReminder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MedicationDetailId");

                    b.HasIndex("UserId", "IsEnabled")
                        .HasDatabaseName("idx_reminder_user_enabled");
            ...
            modelBuilder.Entity("HealthRecord.API.Models.Entities.MedicationLog", b =>
                {
                    b.HasOne("HealthRecord.API.Models.Entities.MedicationReminder", "Reminder")
                        .WithMany("Logs")
            ...
            modelBuilder.Entity("HealthRecord.API.Models.Entities.MedicationReminder", b =>
                {
                    b.HasOne("HealthRecord.API.Models.Entities.MedicationDetail", "MedicationDetail")
                        .WithMany()
                        .HasForeignKey("MedicationDetailId")
                        .OnDelete(DeleteBehavior.SetNull);
